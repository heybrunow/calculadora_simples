...
public class CalculadoraIMC {
	...
	public static void calculaIMC () {
		...
		System.out.println("O seu IMC é: " + imc + "e sua classificação é: "+ consultaClassificacao(imc));
	...
	public static String consultaClassificacao(double imc) {
		...
		else if(imc  >= 30.0 && imc <= 34.9) { return "Obesidade de classe I";}
		else if(imc  >= 35.0 && imc <= 39.9) { return "Obesidade de classe II";}
		else {
